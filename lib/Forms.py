...
class MultiCheckboxField(SelectMultipleField):
    widget = MulticolumnTableWidget(columns=3)
...
class GalaxyForm(BaseForm):
    ...
    sb_v_low = FloatField(u"Apparent average surface brightness lower bound (Johnson,V)",default=40.,validators=[validators.NumberRange(min=15.,max=45.),GreaterThan('sb_v_high')])
    sb_v_high = FloatField(u"Apparent average surface brightness upper bound (Johnson,V)",default=30.,validators=[validators.NumberRange(min=15.,max=45.)])
